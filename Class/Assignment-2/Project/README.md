...
Saya membuat prototype program untuk menu kopi dari suatu cafe yang memungkinkan opsi-opsi seperti penggunaan es, decaf, dan penjelasan komposisi kopi untuk orang yang belum mengetahuinya.
...
Sebagai prototype, saya hanya membuat satu parent class untuk 2 subclass, OOP memudahkan pembuatan jenis jenis kopi lain dan managementnya
...
Saya membuat abstract class `Espresso` untuk kopi kopi yang dibuat menggunakan espresso

2.  Encapsulation

Semua atribut saya buat `private` karena adanya function getter yang memungkinkan akses untuk subclass

3. Inheritance & Polymorphism

Terdapat 2 subclass, `Cappuccino` dan `Americano` yang inherit dari abstract class `Espresso`
